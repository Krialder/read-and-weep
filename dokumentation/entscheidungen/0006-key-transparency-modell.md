...
Das ist ein eigenes Subsystem mit eigenem Datenmodell und eigener Betriebslast, kein Feature, das man nebenbei einbaut. Die größte offene Frage ist die Governance: Wer betreibt die Auditoren. Ohne eine unabhängige Instanz ist der Schutz gegen den Split View schwächer. Diese Frage steht in [offene-fragen.md](../offene-fragen.md).
